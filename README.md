...
| `gateOpeningDelay` | The delay in milliseconds between triggering the gate and transitioning the accessory state to opening/open. Default is `1000`. |
