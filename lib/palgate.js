      ...
      let gates = data.devices.flatMap((deviceData) => {
        ...
        return gateEntries.map((gateEntry) => {
          ...
          if (custom) {
            ...
            return { deviceId: gateDeviceId, name, exposeGarageDoor, exposeSwitch, exposeLock, exposeHoldOpenLock, exposeHoldClosedLock, deviceData };
          } else {
            ...
            return { deviceId: gateDeviceId, name: gateDefaultName, exposeGarageDoor, exposeSwitch, exposeLock, exposeHoldOpenLock, exposeHoldClosedLock, deviceData };
          }
        });
